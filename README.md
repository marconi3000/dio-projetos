...
## Com base nas aulas e arquivos inseridos na ferramenta NotebookLM, foi desenvolvida diversas atividades com esta ferramenta:
...
# 3º Prompt de Estruturação de Conteúdo Criativo (Roteirização) combinado com Solicitação de Persona e Recursos Multimodais.
## As características principais desse estilo são:
- Contextualização de Tarefa Complexa: Eu não pedi somente o texto, mas a organização em formato de vídeo, dividida por perguntas específicas.
- Engenharia de Tom e Audiência: Ao solicitar uma fala "tranquila e animada", defini a persona do assistente para que a comunicação fosse acessível.
- Solicitação de Elementos Visuais Suplementares: pedi a inclusão de slides, vídeos e memes ajuda a IA a pensar em como o conteúdo pode ser consumido visualmente, o que é ideal para apresentações e redes sociais.
- Integração de Provas Sociais/Autoridade: Ao exigir o destaque de versículos e a origem das fontes, garanti que o roteiro tivesse embasamento teológico e técnico, essencial para um estudo sério.

### Segue o que foi digitado no prompt:
Crie um vídeo explicativo com base nos seguintes questionamentos:
1º Por que algumas denominações religiosas exigem o dízimo de forma obrigatória?
2º Para o que deve ser destinado o dízimo? 
3º Se o dízimo não é mais obrigatório, como devo contribuir/ofertar nos dias atuais? 
4º O dízimo é somente em dinheiro, não há outras formas de contribuir? 
5º Se não tenho nada a oferecer, como vou contribuir? 
Que a fala seja tranquila e animada, que mantenha a organização das perguntas, Produza slides/vídeos/memes que se relacionem as falas, e explique a origem das respostas (fontes) e destaque versículos bíblicos. 

Segue o resultado: 
---
Roteiro do Vídeo: O Dízimo e a Liberdade de Contribuir
(Cena de Abertura)
